...
var ChartComponent = class {
  ...
  ngOnChanges(changes) {
    asapScheduler.schedule(() => {
      if (this.autoUpdateSeries && Object.keys(changes).filter((c2) => c2 !== "series").length === 0) {
  ...
  createElement() {
    ...
    this.ngZone.runOutsideAngular(() => {
      this.chartObj = new gs(this.chartElement.nativeElement, options);
    });
    this.render();
  }
  render() {
...
ChartComponent.ɵcmp = ɵɵdefineComponent({
  ...
  viewQuery: function ChartComponent_Query(rf, ctx) {
    ...
    if (rf & 2) {
      let _t2;
      ɵɵqueryRefresh(_t2 = ɵɵloadQuery()) && (ctx.chartElement = _t2.first);
    }
  },
  inputs: {
    chart: "chart",
